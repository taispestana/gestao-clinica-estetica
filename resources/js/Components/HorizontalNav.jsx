...
export default function HorizontalNav() {
    const navItems = [
        ...
        },
        {
            name: 'Tratamentos', icon: (
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-flower1 w-4 h-4" viewBox="0 0 16 16">
    ...
    return (
        <nav className="d-none d-sm-block d-lg-none overflow-x-auto mt-3 px-4 px-md-5">
            <ul className="nav nav-pills flex-nowrap p-2 gap-2 justify-content-center" style={{ whiteSpace: 'nowrap' }}>
                {navItems.map((item) => (
                    <li className="nav-item" key={item.name}>
                        ...
                        >
                            <span className="d-flex align-items-center justify-content-center" style={{ width: '18px', height: '18px' }}>
                                {item.icon}
                            </span>
