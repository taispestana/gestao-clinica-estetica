...
//     const appointments = [
//         { name: 'Nome do Cliente', contacto: 'contacto', status: 'Ativo', color: 'var(--status-green)' },
//         { name: 'Nome do Cliente', contacto: 'contacto', status: 'Pendente', color: 'var(--status-yellow)' },
//         { name: 'Nome do Cliente', contacto: 'contacto', status: 'Inativo', color: 'var(--status-red)' },
//     ];
...
//                 <button className="btn text-white" style={{ backgroundColor: 'var(--primary-button)' }}>+ Novo Cliente</button>

//                 <div className="w-25 me-5">
//                     <select className="form-select bg-light border-1 text-muted" aria-label="Pesquisar por nome">
...
//                     <select className="form-select bg-light border-1 text-muted" aria-label="Status">
...
//                                     </div>
//                                     <div className="text-end d-flex flex-column align-items-end">
//                                         <button href="#" className="btn" style={{ backgroundColor: 'var(--primary-button)', color: 'var(--white)' }}>Ver Mais</button>
//                                     </div>
//                                 </div>
//                             ))}
//                         </div>
