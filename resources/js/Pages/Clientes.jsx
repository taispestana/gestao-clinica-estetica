...
export default function Clientes() {
    ...
    const stats = [
        { title: 'Clientes Ativos', value: '248', icon: 'users', color: 'var(--status-green)' },
        { title: 'Agendamentos Hoje', value: '12', icon: 'calendar', color: 'var(--status-green)' },
        { title: 'Agendamento Mensal', value: '36', icon: 'calendar-month', color: 'var(--status-green)' },
    ];

    const appointments = [
        { name: 'Ana Maria Costa Silva', contacto: '932 333 321', status: 'Ativo', color: 'var(--status-green)' },
        { name: 'Maria Betânia Silva', contacto: '932 333 321', status: 'Ativo', color: 'var(--status-green)' },
        { name: 'Fábio Costa Lima Ferreira', contacto: '932 333 321', status: 'Ativo', color: 'var(--status-green)' },
    ];
                        ...
                        <div key={index} className="col-4 col-md-4 px-1 px-md-3">
                            <div className="card border-0 shadow-sm h-100" style={{ backgroundColor: 'var(--main-green-lighter)' }}>
                                <div className="card-body p-2 p-md-4 text-start">
                                    ...
                                    <div className="stat-card-value font-bold text-2xl">{stat.value}</div>
                                    <div className="stat-card-title d-block text-secondary small">{stat.title}</div>
                                </div>
                            </div>
                        </div>
                    ))}
                                        ...
                                        <div className="row align-items-center">
                                            ...
                                            <div className="col-12 d-md-none mb-3">
                                                <div className="d-flex justify-content-between align-items-center mb-1">
                                                    ...
                                                    <div className="badge rounded-pill text-dark small fw-medium" style={{ backgroundColor: appointment.color }}>{appointment.status}</div>
                                                </div>
                                            ...
                                            <div className="d-none d-md-flex col-md-3 text-center">
                                                <div className="text-secondary">{appointment.contacto}</div>
                                            </div>
                                            <div className="d-none d-md-flex col-md-3 text-center">
                                                <span className="badge rounded-pill text-dark" style={{ backgroundColor: appointment.color }}>
                                                    {appointment.status}
                                                </span>
                                            </div>
                                            <div className="col-12 col-md-2 text-end">
                                                <Link href={route('clientes.show')} className="btn btn-gold btn-sm px-3" style={{ borderRadius: '8px' }}>Ver Mais</Link>
                                            </div>
                                        </div>
                                    </div>
                                ))}
                ...
                <div className="p-4 p-md-5 bg-white">
                    ...
                    <form onSubmit={(e) => { e.preventDefault(); closeModal(); }}>
                        ...
                        <div className="mb-4">
                            ...
                            <input type="text" className="form-control bg-light border-0 py-2 rounded-3" placeholder="(__) ____________" />
                        </div>
