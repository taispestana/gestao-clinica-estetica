                    ...
                    <div className="col-lg-8">
                        <div className="card border-0 shadow-sm p-4">
                            <div className="row align-items-center mb-3 px-3 d-none d-md-flex">
                                ...
                                <div className="col-2 text-center"><h3 className="h6 fw-bold text-muted mb-0">Valor</h3></div>
                                ...
                                {filteredTratamentos.length > 0 ? filteredTratamentos.map((tratamento) => (
                                    <div key={tratamento.id} className="card border-0 shadow-sm p-4 bg-white rounded-4">
                                        <div className="d-none d-md-flex row align-items-center w-100 mx-0">
                                            ...
                                            <div className="col-md-2 text-center text-dark fw-bold">{new Intl.NumberFormat('pt-PT', { style: 'currency', currency: 'EUR' }).format(tratamento.preco)}</div>
                                        ...
                                        <div className="d-md-none">
                                            <div className="fw-bold text-dark">{tratamento.nome}</div>
                                            <div className="text-secondary small">{formatDuration(tratamento.duracao)} | {new Intl.NumberFormat('pt-PT', { style: 'currency', currency: 'EUR' }).format(tratamento.preco)}</div>
                                            <div className="mt-2">
                                                <button
