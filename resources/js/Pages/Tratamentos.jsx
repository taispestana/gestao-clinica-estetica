...
export default function Tratamentos() {
    ...
    const closeModal = () => setShowNewTreatmentModal(false);

    const stats = [
        { title: 'Total de Tratamentos', value: '24', icon: 'flower1' },
        ...
        <>
            ...
            <Modal show={showNewTreatmentModal} onClose={closeModal} maxWidth="md">
                <div className="p-4 p-md-5 bg-white">
                    <h4 className="fw-bold mb-4" style={{ color: 'var(--main-text)' }}>Tratamento</h4>
                    ...
                    <form onSubmit={(e) => { e.preventDefault(); closeModal(); }}>
                        ...
                        <div className="mb-4">
                            <label className="form-label small text-secondary fw-medium mb-1">Duração</label>
                            <input type="text" className="form-control bg-light border-0 py-2 rounded-3" style={{ maxWidth: '120px' }} />
                        </div>
